...
"<script>"
"let pwmInterval = null;"  // 👈 Intervalo global
...
"    contenedor.innerHTML += \"<label>Resistencia variable (Ohm):<input type='number' id='res'></label>\";"
"  contenedor.innerHTML += `"
"    <label>Resistencia variable (Ohm):</label>"
"    <div id='resDisplay' style=\""
"      background: #222;"
"      color: #0f0;"
...
"		      .then(json => {"
"		        const resistencia = json.resistencia !== undefined ? json.resistencia : '---';"
"		        const pwm = json.pwm !== undefined ? json.pwm : '---';"
"		        document.getElementById('resDisplay').innerText = ${resistencia} Ohm;"
"    			const pwm_cal = Math.min(8191, Math.max(0, (resistencia / 10000) * 8191));"
"		        document.getElementById('resultado').innerText = Valor PWM actual: ${pwm_cal} / 8191;"
"		      })"
"		      .catch(err => console.error('Error al obtener PWM:', err));"
"		  }, 500);"
"  }"
